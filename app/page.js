...
export default function Home() {
  ...
  const [seansid, setSeansid] = useState([
    {
      ...
      keel: 'Eesti keeles',
      subtiitrid: 'Puuduvad',
      kirjeldus: 'Lõbus ja värviline seiklus kogu perele, kus kloppivad klotsid tekitavad uusi ootamatuid olukordi.',
  ...
  // Uue seansi vorm (LISATUD KEEL JA SUBTIITRID)
  ...
  // Automaatne bännerite vahetumine (7s)
  useEffect(() => {
  ...
  const lisaSeanss = (e) => {
    ...
    const uusObjekt = {
      id: `s-${Date.now()}`, ...uusSeanss, ridu: ridu || 1, kohtiRias: kohtiRias || 2, piletiHind: parseFloat(uusSeanss.piletiHind) || 8.00
    };
    setSeansid([...seansid, uusObjekt].sort((a, b) => (a.kuupaev + a.algusAeg).localeCompare(b.kuupaev + b.algusAeg)));
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white font-sans">
        ...
        <section className="p-8 max-w-4xl mx-auto space-y-8">
          {!onAutenditud ? (
            ...
            <>
              ...
              {/* SEANSSIDE HALDAMINE, KUUPÄEV, KEEL, SUBTIITRID JA HIND */}
              <div className="bg-[#262626] p-6 rounded-2xl border border-gray-700 shadow-xl">
      ...
      {/* 3. VAADE: KAVA (KOOS KUUPÄEVA FILTRIGA) */}
      {aktiivneVaade === 'kava' && (
        <>
